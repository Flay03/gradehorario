    ...
    toDraggableHTML() {
        ...
        return `
            <div class="professor-item" draggable="true" 
                 ondragstart="if(window.sistemaGrade) window.sistemaGrade.dragStart(event, 'professor', '${this.id}')"
                 oncontextmenu="if(window.sistemaGrade) { window.sistemaGrade.mostrarMenuContextoProfessor(event, '${this.id}'); return false; }"
                 data-id="${this.id}">
